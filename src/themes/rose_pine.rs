//! rose_pine theme — STUB. The theme worker replaces this with a real palette,
//! filling every slot of [`crate::model::Theme`] with 256-color indices that
//! evoke the rose_pine palette. Until then it clones Tokyo Night so the crate builds.
//!
